  		...
  		<form id="searchForm">
	  		<table border="0" class="searchForm datagrid-toolbar" width="100%">
	  			<tr>
					...
					<td width="20%">
						<input id="reqData" name="reqData" maxlength="30" class='easyui-textbox' style="width: 148px;height: 24px;"/>
					</td>
			  			<td class="tdR" width="8%">接口类型:</td>
						<td width="20%">
							<select id ="tradeType" name ="tradeType" style="width:148px;" editable="false" data-options="panelHeight:112" class="easyui-combobox">
								<option value="" selected="selected">全部</option>
								<c:forEach var="obj" items="${CodeMap['TRADE_TYPE']}">
					...
					<td width="24%">
						<input id="min_interface_log_time" name="min_interface_log_time" editable='false' maxlength="30" class='easyui-datebox' style="width: 145px;height: 24px;" data-options="required:false" placeholder ="--起始时间--"/>
						至
						<input id="max_interface_log_time" name="max_interface_log_time" editable='false' maxlength="30" class='easyui-datebox' style="width: 145px;height: 24px;" data-options="required:false" placeholder ="--终止时间--"/>
					</td>
				</tr>
				<tr>
					<td class="tdR" width="8%">响应报文:</td>
					<td width="20%">
						<input id="respResult" name="respResult" maxlength="30" class='easyui-textbox' style="width: 148px;height: 24px;"/>
					</td>
					<td class="tdR" width="8%">系统对接标识:</td>
					<td width="20%">
						<select id ="systemDocking" name ="systemDocking" style="width:148px;" editable="false" data-options="panelHeight:112" class="easyui-combobox">
							<option value="" selected="selected">全部</option>
