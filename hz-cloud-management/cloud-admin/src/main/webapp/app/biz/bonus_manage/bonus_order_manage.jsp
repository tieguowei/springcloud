...
<html>
	...
	<script type="text/javascript">
		...
		function toFindUsername(){
			...
			if(rows.length > 0){
				...
				$("#onSuperiorUsername").html("");
				$("#teamUsername").html("");
				$("#selectUsernameDiv").dialog('open');
				var loginUserUsername = rows[0].loginUsername;
				var superiorUsername = rows[0].superiorUsername;
				var onSuperiorUsername = rows[0].onSuperiorUsername;
				var teamUsername = rows[0].teamUsername;
				$("#loginUserUsername").html(loginUserUsername);//用户手机号
				$("#superiorUsername").html(superiorUsername);//上级合伙人手机号
				$("#onSuperiorUsername").html(onSuperiorUsername);//上上级合伙人手机号
				$("#teamUsername").html(teamUsername);//团队管理者手机号
				/* $.ajax({
					async:false,
					type:'post',
					data : {"userId":userId},
					...
					success:function(data){
						...
						$("#onSuperiorUsername").html(data.onSuperiorUsername);//上上级合伙人手机号
						$("#teamUsername").html(data.teamUsername);//团队管理者手机号
					}
				}); */
			}else{
				$.messager.show({
  ...
  <body class="easyui-layout" fit="true" style="width: 100%;height: 100%;">
  		<div region="north" border="false" style="height:175px; overflow:hidden;">
  		<form id="searchForm">
				...
				<tr>
					<td class="tdR">下单时间:</td>
	  				...
	  				<td  class="tdL" colspan="2">
						...
						<sec:authorize ifAnyGranted='${ctrl.bonus_mgr_is_show}'><a href="javascript:void(0);" class="easyui-linkbutton" style="min-width:46px;" onclick="doExport()">导出</a></sec:authorize>
					</td>
	  			</tr>
			</table>
		</form>
	...
	<div id="toolbar" style="display: none;">
		<sec:authorize ifAnyGranted='${ctrl.bonus_mgr_is_show}'>
	...
	<!--查看用户敏感信息 -->
	<div id="selectUsernameDiv" style="display: none; overflow: hidden;width:35%;height:45%;"class="easyui-dialog" title="查看奖励单用户敏感信息" data-options="iconCls:'icon-search',closed:true" >
		<form id="selectUsernameForm" style="width:100%;">
			<table border="0" class="searchForm" style="width:100%;">
				...
				<tr></tr>
				<tr>
					<td style="font-size: 14px;width: 50%;" align="right" >上上级合伙人手机号 : </td>
					<td><span id="onSuperiorUsername" style="font-size: 14px"></span></td>
				</tr>
				<tr></tr>
				<tr>
					<td style="font-size: 14px;width: 50%;" align="right" >团队管理者手机号 : </td>
					<td><span id="teamUsername" style="font-size: 14px"></span></td>
				</tr>
			</table>
		</form>
	</div>
