...
<html>
  ...
  <body class="easyui-layout" fit="true" style="width: 100%;height: 100%;">
	...
	<!--查看用户敏感信息 -->
	<div id="selectUsernameDiv" style="display: none; overflow: hidden;width:30%;height:35%;"class="easyui-dialog" title="查看用户敏感信息" data-options="iconCls:'icon-search',closed:true" >
