		...
		datagrid = $('#datagrid').datagrid({
			...
			columns : [[{
				...
				formatter:function(value,rowData,rowIndex){
					...
					return retStr = "<a href='#' onclick='updatePartnerOrganizationInfo(\"" + rowData.organization_id + "\");' >编辑</a>";
				}
			}]]
		});
	}
		...
		organizationForm.form('submit',{
			...
			success:function(msg){
				...
				if(data.messageCode == 'fail'){
					$.messager.alert('提示信息','组织名称不允许重复！','error');
				}else if(data.messageCode == 'nameErr'){
					$.messager.alert('提示信息','组织名称不能为空！','error');
				}else{
