    ...
    <form id="organizationForm" class="easyui-form" method="post" modelAttribute="partnerOrganization">
		...
		<table class="tableForm" width="100%" border="0">
			...
			<tr>
				...
				<td width="70%">
					<input type="text" id="prepaymentDate" name="organizationName" value="${partnerOrganizationInfo.organization_name}" class='easyui-textbox' data-options="required:true,validType:['length[0,30]']" style="width: 175px;height: 24px;"/>
				</td>
			</tr>
			<tr>
				<td class="tdR">上级:</td>
			...
			<tr>
				<td class="tdR" width="30%">简称:</td>
				<td width="70%">
					<input type="text" id="prepaymentDate" name="shortName" value="${partnerOrganizationInfo.short_name}" class='easyui-textbox' data-options="validType:['length[0,20]']" style="width: 175px;height: 24px;"/>
				</td>
			</tr>
			<tr>
