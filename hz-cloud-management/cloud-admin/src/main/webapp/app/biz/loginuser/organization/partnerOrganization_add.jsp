    ...
    <form id="organizationForm" class="easyui-form" method="post" modelAttribute="partnerOrganization">
		...
		<table class="tableForm" width="100%" border="0">
			<tr>
				...
				<td width="70%">
					<input type="text" id="prepaymentDate" name="organizationName" class='easyui-textbox' data-options="required:true,validType:['length[0,30]']" style="width: 175px;height: 24px;"/>
				</td>
			</tr>
			<tr>
				<td class="tdR">上级:</td>
			...
			<tr>
				...
				<td width="70%">
					<input type="text" id="prepaymentDate" name="shortName" class='easyui-textbox' data-options="validType:['length[0,20]']" style="width: 175px;height: 24px;"/>
				</td>
			</tr>
			<tr>
