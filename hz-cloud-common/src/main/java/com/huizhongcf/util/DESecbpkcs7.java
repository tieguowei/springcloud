...
public class DESecbpkcs7 {
    ...
    public static void main(String[] args) throws Exception{
    	...
    	//base64解密
//    	String key = new String(des7Object.base64Decode.decodeBuffer("U9CaWxzZTI4Mzc0dWhqd2VIWldETSUxF"),"UTF-8");
//    	System.out.println(Base64.encode("oSvLxo2/MaXk0wdU18Ly13nEoFPohopXzzXc3UKaTiJ1IoX/bCvlRO4l/LD6QPhEtkg0DfJSl2josVNhNEITgCnFMweiEFm3hiZN3MDY6fy7gAMWMERyTl1RemlUi9Am".getBytes("UTF-8")));
    	System.out.println(getEncrypt("hzcf2016@dlr#cfzh2016dlr", "{\"Mobile\":\"1380006056\"}"));
    	System.out.println(getDecrypt("hzcf2016@dlr#cfzh2016dlr", "ML7r6Va5c/YoRa0alMuVRO74GhCrEeMwDXgKjfF09o0mLzyJ66UkNMWV8td3eeEtd58Wh05KCyL0\r\ny5deJ5fY1ST6WUPxB/rI82BG1D3uMLg="));
    }
